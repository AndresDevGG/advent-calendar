    ...
    >
      ...
      >
        <div class="flex justify-between items-center">
          <div class="day-icon">
            <Icon icon={"mingcute:" + selectedDay.icon} />
          </div>
        ...
        <div class="modal-header">
          ...
          <div class="illustration-container">
            <img
              src={selectedDay.illustration}
              alt="Ilustración del día {selectedDay.day}"
              class="day-illustration"
            />
          </div>
        </div>
        ...
        <div class="modal-footer">
          <button class="close-btn" onclick={closeModal}> ¡Gracias! </button>
        </div>
      </div>
    </div>
  {/if}
