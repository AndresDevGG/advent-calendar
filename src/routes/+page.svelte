<script lang="ts">
  ...
  let selectedDay: AdventDayData | null = null;
  let showModal = false;
...
<div class="page-container">
  ...
  <AdventCalendar year={2024} {testMode} onDayClick={handleDayClick} />
    ...
    <div class="modal-overlay" on:click={closeModal}>
      <div class="modal-content" on:click|stopPropagation>
        ...
        <div class="modal-body">
          ...
          <p>
            ¡Felicidades! Has descubierto la sorpresa del día {selectedDay.day} de
            octubre.
          </p>
        ...
        <div class="modal-footer">
          <button class="close-btn" on:click={closeModal}> ¡Gracias! </button>
        </div>
      </div>
    </div>
  {/if}
